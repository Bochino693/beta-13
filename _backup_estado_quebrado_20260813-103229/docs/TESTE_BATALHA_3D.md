...
O projeto trata o aviso `inference_on_variant` como erro. Por isso os scripts
3D declaram explicitamente resultados obtidos de dicionários. O validador
também bloqueia novas declarações `:=` diretamente baseadas em `.get()`.

...
5. Rodar `python tools/validate_project.py`, `python tools/simulate_balance.py` e o analisador GDScript disponível antes de entregar.
...
- Vantagens elementais: `scripts/autoload/creature_db.gd`.

...
## Battle V2: integra CinematicBeastSprite3D V5, PhysicalProjectile,
...
func _executar_golpe(atacante: int, lutador: Dictionary, alvo: Dictionary, golpe: Dictionary) -> void:
	...
	var sprite_atacante: CinematicBeastSprite3D = _sprites[atacante]
	var sprite_defensor: CinematicBeastSprite3D = _sprites[defensor]
...
func _executar_escudo(jogador: int, lutador: Dictionary) -> void:
	var sprite: CinematicBeastSprite3D = _sprites[jogador]
